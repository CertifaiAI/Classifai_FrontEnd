...
export class utils {
  ...
  public MatchStringHead(StrToMatch: string, oristr: string): boolean {
    try {
      ...
      console.log(
        'MatchStringHead(StrToMatch:string, oristr:string) ----> ',
        err.name + ': ',
        err.message
      );
      return false;
