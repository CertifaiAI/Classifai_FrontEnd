...
@Component({
    selector: 'audio-labelling-project',
    templateUrl: './audio-labelling-project.component.html',
    styleUrls: ['./audio-labelling-project.component.scss'],
    // changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AudioLabellingProjectComponent implements OnInit, OnChanges, OnDestroy {
