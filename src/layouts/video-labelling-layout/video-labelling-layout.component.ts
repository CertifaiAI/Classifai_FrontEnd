...
import { EventEmitter_Url } from 'shared/types/labelling-type/image-labelling.model';
...
export class VideoLabellingLayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _videoDataSetService: DataSetLayoutService,
    ...
    getSelectedProjectMeta(projectName: string): void {
        ...
        projMetaStatus$.pipe(first()).subscribe((response) => {
            ...
            //     response.content.is_video_frames_extraction_completed,
            //     response.content.extracted_frame_index,
            //     response.content.video_file_path,
            //     response.content.frames_per_second,
            //     response.content.video_duration,
            // );
        });
    }
